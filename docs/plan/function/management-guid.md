...
로그인 기능의 상세 디자인 명세는 `docs/plan/layout/design-system` 아래 문서에서 관리하고, 이 문서에서는 참조만 연결한다.
...
| 로그인 화면 상세 디자인 | [auth-login.md](../layout/design-system/auth-login.md) | 로그인 화면의 상세 디자인 적용 기준 |
| 공통 UI 컴포넌트 | [components-ui.md](../layout/design-system/components-ui.md) | `Input`, `Button` 등 공통 UI 기준 |
| 공통 레이아웃 컴포넌트 | [components-layout.md](../layout/design-system/components-layout.md) | `auth shell` 등 공통 레이아웃 기준 |
